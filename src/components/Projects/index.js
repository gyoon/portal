			...
			<div className="contact-content">
					<div className="row">
							...
							<div className="col-lg-12">
									<h2 className="page-header">Project Tire(d)</h2>
										<div className="col-lg-3 col-md-4 col-xs-6 thumb">
												<Link className="thumbnail" to="/portal/projects/projectTired">
										...
										<Link className='gray' to="/portal/portal/projectTired">
						...
						}
						{
							<div className="col-lg-12">
									<h2 className="page-header">BackOffice</h2>
										<div className="col-lg-3 col-md-4 col-xs-6 thumb">
												<Link className="thumbnail" to="/portal/projects/backOffice">
										...
										<Link className='gray' to="/portal/projects/backOffice">
											<p className='text-size-link'>read more...</p>
										</Link>
										<br/>
										<br/>
						...
						}
						{
							...
							// 			<div className="col-lg-3 col-md-4 col-xs-6 thumb">
							// 					<Link className="thumbnail" to="/portal/projects/projectDinger">
							// 						<img className="img-responsive heighted" src={require('../../assets/not_available.jpeg')}  alt="no image available!" />
							// 					</Link>
							// 			</div>
