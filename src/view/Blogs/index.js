		...
		return (
			<div className="row">
					<div className="blog-content-main">
						<Link className="page-header gray" onClick={this.props.hideSideBar} to="/portal/reactTutPart1">
							...
							<div className="blog-content">
								...
								first part.<Link className='gray' onClick={this.props.hideSideBar} to="/portal/reactTutPart1"><p className='text-size-link'> read more...</p></Link>
							</div>
					...
					<h2 className="page-header gray"><a href="#">React Web Blog Version 1.0</a></h2>
						<div className="blog-content">
							...
							<a target='_blank' rel='nofollow' className='gray' href="https://github.com/DeFuex/portal/tree/develop">
							https://github.com/DeFuex/portal/tree/develop</a>.
						</div>
