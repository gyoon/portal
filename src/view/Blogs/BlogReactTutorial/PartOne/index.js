			...
			<div className="row">
					<div className="entry-content-main">
					  <h2>React Tutorial - Part 1</h2>
						<div>
						<br/>
						<h3>New vs. „Old“ Web Development</h3>
...
<br/>
<h3>Project Structure (Flux architecture)</h3>
<p>
...
<br/>
<br/>
<img src={require('../../../../assets/part1_image1.png')} width="40%" />
<br/>
<br/>
<br/>
<br/>
...
<br/>
<img src={require('../../../../assets/part1_image2.png')} width="40%" />
<br/>
<br/>
<p>
...
<p>
<span>NODE_ENV</span> = is an environment variable which is mainly used to check if a node application is in production or development. A typical use-case is to give additional log or debug information if the variable is set to development.
</p>
<p>
<span>Cross-env</span> = it is used to set the NODE_ENV variable regardless of the operating system.
</p>
<p>
...
<br/>
<h3>Webpack & webpack-dev-server</h3>
<p>
...
<br/>
<h3>Webpack config for development</h3>
<p>
...
<br/>
<p>
<span>path</span> = is a copy of the NodeJS path module and is used to find paths inside our project. Nothing more, nothing less.
( <a className='gray' target='_blank' href='https://www.npmjs.com/package/path'>https://www.npmjs.com/package/path</a> )
</p>
<p>
<span>Html-webpack-plugin</span> = at some point we will need an entry point to host our website. This plugin is used to create an html5 template file ( index.html ) that includes all webpack bundles that are build. This means that every javascript file will be automatically added inside a {'<script>'} tag.
...
<p>
<span>Extract-text-webpack-plugin</span> = this plugin will be used to add a css file inside our template index.html via {'<link>'} tag. It kind of works together with the html-webpack-plugin.
...
<p>
<span>Appcache-webpack-plugin</span> = a plugin to cache assets and create a manifest.appcache file.
...
<p>
<span>react-static-webpack-plugin</span> = this plugin will help to build our static web page content. More about this plugin later.
...
<br/>
<h3>Webpack config and loader modules</h3>
<p>
...
<p>
Since hot reloading is included in webpack we need to activate it with the <span>webpack.HotModuleReplacementPlugin()</span> method. The <span>HtmlWebpackPlugin( .. )</span> will be used to define our entry html5 file to inject {'<script>'}- and {'<link>'} tags. And that’s it.
</p>
<br/>
<p>
...
<br/>
<h3>How to define the build output</h3>
<SyntaxHighlighter language='javascript' style={rainbow}>
{
	`return {
    entry: entry,
...
<br/>
<p>
<span>publicPath</span> = This is the path that will be used to search for relative files on your development or production server. If we would start our development server, the entry point would search in the root directory of the deployed files.
</p>
<br/>
<p>
<span>filename</span> = This attribute is used to define a name for the bundled js file. I generally called it bundle.js, because in most cases you will find repositories out there that define it just as bundle.js, but you do not have to name it like that. You can call it whatever you want.
</p>
<p>
...
<h3>Module Loader Configurations</h3>
<SyntaxHighlighter language='javascript' style={rainbow}>
{
	`module: {
    loaders: [
...
<p>
<span>module</span> = the attribute where a loader group is defined.
</p>
<p>
<span>loaders</span> = the attribute to define a group (array) of loaders.
</p>
<p>
<span>test</span> = this attribute is used to specify the file types we are searching for.
</p>
<p>
<span>loader</span> = the attribute to define a specific loader, which is nothing else than a library dependency we use.
</p>
<p>
<span>exclude</span> = this attribute is used to tell a loader to stop searching in specific directories.
</p>
<p>
...
We use the <span>url-loader</span> for images, since javascript doesn’t need a transcription for those files and the <span>file-loader</span> for as yet unknown file types.
</p>
<br/>
<p>
...
<p>
<span>plugins</span> = the attribute to set our defined plugins for development (or production)
</p>
<p>
<span>target</span> = the attribute to allow certain commands to be used e.g.: window
</p>
<p>
<span>stats</span> = the attribute to allow stats in the console. Don’t set this command if you build for production!
</p>
<p>
<span>progress</span> = this attribute is set to true if you want to see what webpack is building, else set it to false.
</p>
<p>
...
<br/>
<img src={require('../../../../assets/part1_image3.png')} width="40%" />
<br/>
<br/>
<p>
